...
public class Packets {
    public record C2S_AttackRequest(int comboCount, boolean isHeavyAttacking, boolean isSneaking, int selectedSlot, int[] entityIds) {
        public C2S_AttackRequest(int comboCount, boolean isHeavyAttacking, boolean isSneaking, int selectedSlot, List<Entity> entities) {
            this(comboCount, isHeavyAttacking, isSneaking, selectedSlot, convertEntityList(entities));
        }
        ...
        public PacketByteBuf write() {
            ...
            buffer.writeBoolean(isHeavyAttacking);
        ...
        public static C2S_AttackRequest read(PacketByteBuf buffer) {
            ...
            boolean isHeavyAttacking = buffer.readBoolean();
